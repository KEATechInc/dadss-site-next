...
const TouchTech = () => {
  ...
  return (
    <>
      ...
      <TouchWrapper>
        <HeadBlock>
          <Header1>Touch Technology</Header1>
          <Divider />
        </HeadBlock>
        ...
        <ContentBlock className='Orange'>
          ...
          <Content>
            The touch system analyzes alcohol found beneath the driver’s
        ...
        <ContentBlock>
          ...
          <Content>
            The DADSS Research Program has created a touch standard
        ...
        <ContentBlock className='Gray'>
          ...
          <Content className='White'>
            ...
            touch technology will use driver presence detectors in the
